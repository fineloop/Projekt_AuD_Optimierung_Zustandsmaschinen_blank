...
#pragma warning(disable:   4996)//Unsafe warning for freopen disabled _CRT_SECURE_NO_WARNINGS
...
void CConsole::RedirectToConsole (WORD wFlags)
	...
	//FILE                       *fp;
	//redirect was changed from direct pointer removal:
	//e.g
